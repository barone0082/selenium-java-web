...
@Test
	public void preencheCampos(){
		...
		wait.until(ExpectedConditions.textToBePresentInElementValue((estado),"SP"));
		...
		assertEquals("",rua.getAttribute("value"));
		assertEquals("",numero.getAttribute("value"));
		assertEquals("",complemento.getAttribute("value"));
		assertEquals("",bairro.getAttribute("value"));
		assertEquals("",cidade.getAttribute("value"));
		assertEquals("",estado.getAttribute("value"));
